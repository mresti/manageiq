class ChangeCostsAsMonetize < ActiveRecord::Migration[5.0]
  def up
    ...
    add_monetize :showback_rates, :fixed_cost, :amount => { :null => true, :default => nil }
    add_monetize :showback_rates, :variable_cost, :amount => { :null => true, :default => nil }
  end

  def down
    remove_monetize :showback_rates, :variable_cost
    remove_monetize :showback_rates, :fixed_cost
